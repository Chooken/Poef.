...
public class PlayerMovementAddon : PlayerAddon
{
    private void Start()
    {
...
//public FrameInput Input { get { return m_player.FrameInput; } }
...
//private RaycastHit2D _colUp, _colDown, _colRight, _colLeft;
...
//    RaycastHit2D RunDetection(RayRange range)
//    {
//        RaycastHit2D hit = new RaycastHit2D();

//        foreach (Vector2 point in EvaluateRayPositions(range))
//        {
//            hit = Physics2D.Raycast(point, range.Dir, _detectionRayLength, _groundLayer);
...
//    if (_currentHorizontalSpeed > 0 && (_colRight && _colRight.normal.x != 1) || _currentHorizontalSpeed < 0 && (_colLeft && _colLeft.normal.x != -1))
//    {
//        Debug.Log($"Colision: {_colRight.collider != null}, Collision Normal: {_colRight.normal}");
...
//        if (_currentVerticalSpeed < 0) { _currentVerticalSpeed = 0; transform.Translate(Vector3.down * _colDown.distance); }
//    }
//    else
//    {
...
//    if ((Input.JumpDown && _colDown) || (Input.JumpDown && CanUseCoyote) || HasBufferedJump)
//    {
